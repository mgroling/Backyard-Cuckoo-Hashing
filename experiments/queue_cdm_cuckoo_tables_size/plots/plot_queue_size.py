...
grouped_data = data.groupby(['insert_loop_iterations', 'time_step'])['queue_size'].agg(['mean', 'std']).reset_index()
...
# Save the plot
output_file = folder + "plots/bin_capacity_{}/queue_size_bin_cap_{}.png".format(bin_capacity, bin_capacity)
